...
public class HeroActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Picasso.with(this).load(heroes[hero.getSuggested()[0]].getImageResource())
                .transform(transformation).into(hero1);

        Picasso.with(this).load(heroes[hero.getSuggested()[1]].getImageResource())
                .transform(transformation).into(hero2);

        Picasso.with(this).load(heroes[hero.getSuggested()[2]].getImageResource())
